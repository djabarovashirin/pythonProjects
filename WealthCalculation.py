### This Python script is a simple financial calculator that allows users to project their wealth growth
### over time based on monthly savings and an estimated rate of return.
### It includes two main functions: one to calculate wealth by year and
### another to estimate the number of years needed to achieve a target wealth (financial freedom)
